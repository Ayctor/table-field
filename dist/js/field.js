...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-table-field', __webpack_require__(3));
  Vue.component('detail-table-field', __webpack_require__(6));
  Vue.component('form-table-field', __webpack_require__(9));
});
      ...
      _c("template", { slot: "value" }, [
        _c("div", { staticClass: "w-full overflow-hidden" }, [
          _c("div", { staticClass: "overflow-x-auto" }, [
            _c("table", { staticClass: "w-full border border-collapse" }, [
              _c("thead", [
                _c(
                  "tr",
                  _vm._l(_vm.data[0], function(column, index) {
                    return _c(
                      "th",
                      { key: index, staticClass: "p-2 border text-left" },
                      [
                        _vm._v(
                          "\n                                " +
                            _vm._s(column) +
              ...
              _c(
                ...
                _vm._l(_vm.data, function(row, index) {
                  return _c(
                    "tr",
                    { key: index },
                    _vm._l(row, function(column, subindex) {
                      return index !== 0
                        ? _c(
                            "td",
                            { key: subindex, staticClass: "p-2 border" },
                            [
                              _vm._v(
                                "\n                                " +
                                  _vm._s(column) +
    ...
    methods: {
        ...
        setInitialData: function setInitialData() {
            if (this.value !== "") {
                ...
                for (var index = 1; index < this.rows; index++) {
                    var row = [];
                    for (var subindex = 0; subindex < this.columns; subindex++) {
                        row[subindex] = "";
                    }
                    this.data[index] = row;
                }
         ...
         * Change the value.
         */
        changeValue: function changeValue(event, row, column) {
    ...
    [
      _c("template", { slot: "field" }, [
        _c("input", {
          ...
          attrs: { id: _vm.field.name, type: "hidden" },
        ...
        _c("div", { staticClass: "w-full overflow-hidden" }, [
          _c("div", { staticClass: "overflow-x-auto" }, [
            _c("table", { staticClass: "table_field" }, [
              _c(
                "tbody",
                { staticClass: "table_field__body" },
                [
                  _vm._l(_vm.data, function(row, index) {
                    return _c(
                      "tr",
                      { key: index, staticClass: "table_field__row" },
                      [
                        _c("td", { staticClass: "table_field__column" }, [
                          _c("div", { staticClass: "table_field__buttons" }, [
                        ...
                        _vm._l(row, function(column, subindex) {
                          return _c(
                            ...
                            {
                              key: subindex,
                              staticClass: "table_field__column"
                            },
                            [
                              index === 0
                                ? _c(
                                    "div",
                                    { staticClass: "table_field__heading" },
                                    [
                                      _c(
                                        "button",
                                        {
                                          staticClass:
                                            "table_field__button table_field__button--add",
                                          attrs: {
                                            type: "button",
                                            title: _vm.addColumnButtonLabel
                                          },
                                          on: {
                                            click: function($event) {
                                              $event.preventDefault()
                                              return _vm.addColumn(subindex)
                                            }
                                          }
                                        },
                                        [
                                      ...
                                      _vm._v(" "),
                                      _c("input", {
                                        staticClass: "table_field__input",
                                      ...
                                      _c(
                                        ...
                                        {
                                          staticClass:
                                            "table_field__button table_field__button--remove",
                                          attrs: {
                                            type: "button",
                                            title: _vm.removeColumnButtonLabel
                                          },
                                          on: {
                                            click: function($event) {
                                              $event.preventDefault()
                                              return _vm.removeColumn(subindex)
                                            }
                                          }
                                        },
                                        [
                        ...
                        _c("td", { staticClass: "table_field__column" }, [
                          index === 0
                            ? _c(
                                ...
                                {
                                  staticClass:
                                    "table_field__buttons table_field__buttons--start"
                                },
                                [
                                  _c(
                                    "button",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                                          return _vm.addColumn(_vm.columns)
                                        }
                                      }
                                    },
                                    [
                            ...
                            : _c(
                                ...
                                {
                                  staticClass:
                                    "table_field__buttons table_field__buttons--col"
                                },
                                [
                                  _c(
                                    "button",
                                  ...
                                  _c(
                                    "button",
                                    {
                                      ...
                                      attrs: {
                                        type: "button",
                                        title: _vm.removeRowButtonLabel
                                      },
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                  ...
                  _vm._v(" "),
                  _c("tr", { staticClass: "table_field__row" }, [
                    _c("td", { staticClass: "table_field__column" }),
                    _vm._v(" "),
                    _c("td", {
                      staticClass: "table_field__column",
                    ...
                    _c("td", { staticClass: "table_field__column" }, [
                      _c(
                        ...
                        {
                          staticClass:
                            "table_field__buttons table_field__buttons--col table_field__buttons--start"
                        },
                        [
                          _c(
                            "button",
